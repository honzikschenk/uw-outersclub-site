        ...
        <Card className="p-6 mb-6 bg-yellow-50 border-yellow-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-700 text-sm mb-3">
                <strong>Membership can be completed at pickup time during equipment room hours:</strong>
              </p>
              ...
              <Link href="/about" className="inline-block bg-yellow-600 text-white px-4 py-2 rounded text-sm hover:bg-yellow-700 transition-colors">
