          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <Input id="user_id" value={formData.user_id} disabled className="bg-gray-50" />
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Member since {formatDate(formData.joined_on)}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      User can access club services and rent gear
                    </p>
                  </div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      User can access admin dashboard and manage other users
                    </p>
                  </div>
                </div>
                <Switch
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border rounded-lg">
                ...
                <Badge
                  ...
                  className={
                    formData.valid ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                  }
                >
