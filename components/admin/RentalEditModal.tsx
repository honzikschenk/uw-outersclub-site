...
import { Calendar, Package, User, CheckCircle, Clock, AlertTriangle, X } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  value={
                    formData.lent_date
                      ? new Date(formData.lent_date).toISOString().slice(0, 10)
                      : ""
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  type="date"
                  value={
                    formData.due_date ? new Date(formData.due_date).toISOString().slice(0, 10) : ""
                  }
                ...
                <p className="text-blue-900 font-medium">
                  {Math.ceil(
                    (new Date(formData.due_date).getTime() -
                      new Date(formData.lent_date).getTime()) /
                      (1000 * 60 * 60 * 24),
                  )}{" "}
                  days
                </p>
